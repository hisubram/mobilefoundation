...
>Learn more about the certificate pinning API method in the [API Reference](https://mobilefirstplatform.ibmcloud.com/tutorials/en/foundation/8.0/api/client-side-api/).