...
keywords: sdk api, javascript sdk api
...
You must override the system messages at a global JavaScript level, because some parts of the code is run only after the application is successfully initialized.
{: note}
