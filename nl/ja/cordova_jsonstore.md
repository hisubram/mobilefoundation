...
#	Cordova アプリケーションでの JSONStore
{: #cordova_jsonstore}

## 前提条件
{: #prerequisites }
* [JSONStore の概説](jsonstore.html)を読む。
* MobileFirst Cordova SDK が プロジェクトに追加されていることを確認する。 [Cordova アプリケーションへの Mobile Foundation SDK の追加 ![外部リンク・アイコン](../../icons/launch-glyph.svg "外部リンク・アイコン")](https://mobilefirstplatform.ibmcloud.com/tutorials/en/foundation/8.0/application-development/sdk/cordova/){: new_window} のチュートリアルに従ってください。
...
![JSONStore フィーチャーの追加](images/jsonstore-add-plugin.png)
...
> 詳しくは、このチュートリアルの後半にある**『MobileFirst アダプターの統合』**セクションを参照してください。
...
![JSONStore サンプル・アプリケーション](images/jsonstore-cordova.png)
