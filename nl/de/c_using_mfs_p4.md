...
* {{site.data.keyword.mobilefoundation_short}}: Professional Per Capacity wird nur mit {{site.data.keyword.Bluemix_notm}}-Plänen für {{site.data.keyword.Db2_on_Cloud_short}} unterstützt.
