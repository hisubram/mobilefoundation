...
### Per il piano {{site.data.keyword.mobilefoundation_short}}: Developer Pro
...
### Per il piano {{site.data.keyword.mobilefoundation_short}}: Professional Per Capacity
