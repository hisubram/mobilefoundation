...
{{site.data.keyword.mobilefoundation_short}}에서는 {{site.data.keyword.Bluemix_notm}}에 {{site.data.keyword.mfserver_short_notm}} <!--in the {{site.data.keyword.containerlong}} --> 환경을 설정하는 손쉬운 안내 방식을 제공합니다.
...
*	{{site.data.keyword.mfp_oc_long_notm}}은 개발자 및 관리자 모두가 애플리케이션 및 어댑터를 작성, 모니터, 보호 및 관리할 수 있도록 단순화된 워크플로우를 사용하는 웹 기반 UI입니다.
