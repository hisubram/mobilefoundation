...
어댑터에서 Java 메소드 또는 JavaScript 리소스 프로시저 또는 전체 Java 리소스 클래스의 보호 범위를 지정할 수 있습니다. 범위는 공백으로 구분된 하나 이상의 범위 요소 문자열(“scopeElement1 scopeElement2 …”)로 정의되거나 기본 범위를 적용하도록 널로 정의됩니다. 어댑터 리소스 보호에 관한 자세한 정보는 [어댑터 보호](https://console.bluemix.net/docs/services/mobilefoundation/protecting_adapters.html)를 참조하십시오.
