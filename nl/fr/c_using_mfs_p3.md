...
{{site.data.keyword.mobilefoundation_short}} utilisant le plan Developer Pro,
...
spécifier les informations de connexion à l'instance de service {{site.data.keyword.Db2_on_Cloud_short}}.
...
vous êtes membre de cette `organisation` et de cet `espace`.
Vous
...
Mobile Analytics à l'instance de service {{site.data.keyword.mobilefoundation_short}}.
 ...
 Le plan Developer Pro crée l'instance de service Mobile Analytics.
...
fonction de vos besoins, dans la limite de 2 Go.
  ...
  - La zone **Instances** affiche le nombre de noeuds créés. Cette zone n'est pas modifiable dans {{site.data.keyword.mobilefoundation_short}}: Developer Pro. Le
nombre de noeuds est par défaut de **1** dans le plan Developer Pro.
