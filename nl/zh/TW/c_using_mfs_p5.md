...
* 只有 {{site.data.keyword.Db2_on_Cloud_short}} {{site.data.keyword.Bluemix_notm}} 方案才支援 {{site.data.keyword.mobilefoundation_short}}: Professional Per Device。
...
在建立 {{site.data.keyword.mobilefoundation_short}}: Professional Per Device 服務實例之後，就會看到*概觀* 頁面，您將需要在這裡為 {{site.data.keyword.mobilefoundation_short}} 服務實例應該連接至其中的 {{site.data.keyword.Db2_on_Cloud_short}} 服務實例指定連線資訊。
