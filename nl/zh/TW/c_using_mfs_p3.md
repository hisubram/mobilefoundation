...
使用 Developer Pro 方案建立 {{site.data.keyword.mobilefoundation_short}} 服務實例之後，請存取 {{site.data.keyword.Bluemix_notm}} 上的 `Overview` 頁面，而此頁面提供指導教學及視訊，協助您開始使用服務。
...
* 您必須具有 {{site.data.keyword.Db2_on_Cloud_short}} 服務實例認證的存取權，才能配置 {{site.data.keyword.mobilefoundation_short}} 服務實例的設定。
...
使用 Developer Pro 方案建立 {{site.data.keyword.mobilefoundation_short}} 服務實例之後，就會看到*概觀* 頁面，您必須在此頁面中指定 {{site.data.keyword.Db2_on_Cloud_short}} 服務實例的連線資訊。{{site.data.keyword.mobilefoundation_short}} 服務實例必須連接至指定的 {{site.data.keyword.Db2_on_Cloud_short}} 服務實例。

如果您沒有現有 {{site.data.keyword.Db2_on_Cloud_short}} 服務實例，則可以予以建立。

請遵循下列步驟，建立新 Db2 on Cloud 服務實例：
...
請執行下列步驟，連接至現有或新的 {{site.data.keyword.Db2_on_Cloud_short}} 服務實例：
...
> **附註：**如果您未看見，請列出 {{site.data.keyword.Db2_on_Cloud_short}} 服務實例所存在的 `Organization` 及 `Space`，然後檢查您是否為該 `Organization` 及 `Space` 的成員。您需要對組織及空間具有*開發人員* 角色存取權，因為 {{site.data.keyword.mobilefoundation_short}} 服務會從 {{site.data.keyword.Db2_on_Cloud_short}} 服務存取認證。
...
{: #adding_analytics_server_p3}
 ...
 您現在可以在 {{site.data.keyword.mobilefirst}} 伺服器上監視您的行動應用程式，方法是將 Mobile Analytics 服務實例連接至 {{site.data.keyword.mobilefoundation_short}} 服務實例。

 Developer Pro 方案會建立 Mobile Analytics 服務實例。
...
* 按一下**新增分析**將 Mobile Analytics 服務實例新增至 {{site.data.keyword.mobilefoundation_short}} 服務實例。
...
如需 Mobile Analytics 服務的相關資訊，您可以參閱 [MobileFirst Foundation Operational Analytics ![外部鏈結圖示](../../icons/launch-glyph.svg "外部鏈結圖示")](https://mobilefirstplatform.ibmcloud.com/tutorials/en/foundation/8.0/analytics/){: new_window}。
...
> **附註**：來自舊版伺服器實例的資料（包括應用程式及配接器的相關資訊）會持續保存在已配置的 {{site.data.keyword.Db2_on_Cloud_short}} 服務實例中。這項資料可用來重建您的伺服器。
...
*	從**拓蹼**標籤中，您可以視需要選取伺服器大小和記憶體。預設伺服器建立時具有 1 GB 記憶體。
  ...
  - **實例**會顯示已建立的實例數目。在 {{site.data.keyword.mobilefoundation_short}}: Developer Pro 中無法編輯此欄位。在 Developer Pro 方案中，節點數目預設為 **1**。
