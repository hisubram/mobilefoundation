...
* {{site.data.keyword.mobilefoundation_short}}: Professional Per Capacity is supported only with {{site.data.keyword.Db2_on_Cloud_short}} {{site.data.keyword.Bluemix_notm}} plans.
